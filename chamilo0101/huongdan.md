...
## 🚀 CÁCH 1: CÀI ĐẶT TỰ ĐỘNG (1 LỆNH - Khuyến nghị)

### Windows
```batch
REM Mở Command Prompt hoặc PowerShell, chạy:
setup.bat
```
...
|--------------|-----------|
| **Windows** | Double-click `start.bat` hoặc `.\start.ps1` |
| **macOS/Linux** | `bash start.sh` |

### Script tự động làm gì?
1. ✅ Kiểm tra và cài đặt Miniconda (nếu chưa có)
2. ✅ Cài đặt system dependencies (cmake, openblas, etc.)
3. ✅ Tạo môi trường Conda `face_attendance` với Python 3.10
4. ✅ Cài đặt tất cả thư viện Python (PySide6, opencv, dlib, face_recognition...)
5. ✅ Tạo thư mục `known_faces/` và `attendance_records/`
6. ✅ Tạo script `start.sh` / `start.bat` để chạy nhanh

---

## 📦 CÁCH 2: CÀI ĐẶT THỦ CÔNG (Conda)

### Bước 1: Cài Miniconda
- Windows: https://repo.anaconda.com/miniconda/Miniconda3-latest-Windows-x86_64.exe
- macOS: https://repo.anaconda.com/miniconda/Miniconda3-latest-MacOSX-arm64.sh (Apple Silicon) hoặc x86_64
...
## 📥 CÁCH 3: TẢI FILE ĐÃ BUILD SẴN (Không cần cài đặt)
